...
syms delta_x delta_y delta_vx delta_vy;
syms x1 y1 x2 y2 x3 y3 x4 y4 vx_1 vy_1 vx_2 vy_2 vx_3 vy_3 vx_4 vy_4 vx_o vy_o vx_g vy_g;
...
diff_l3 = loc1 - loc3;
dist_l4 = sqrt(sum((loc4-loc1).^2));
diff_l4 = loc1 - loc4;
% when dist_1>25
vx_rel2 = 0.03*(1-25/(dist_l))*-diff_l(1,1);
vx_rel3 = 0.03*(1-25/(dist_l3))*-diff_l3(1,1);
vx_rel4 = 0.03*(1-25/(dist_l4))*-diff_l4(1,1);
vx_rel = 0.03*(1-25/(dist_l))*-diff_l(1,1)+0.03*(1-25/(dist_l3))*-diff_l3(1,1)+0.03*(1-25/(dist_l4))*-diff_l4(1,1);
vy_rel = 0.03*(1-25/(dist_l))*-diff_l(1,2)+0.03*(1-25/(dist_l3))*-diff_l3(1,2)+0.03*(1-25/(dist_l4))*-diff_l4(1,2);
% % when dist_1<25

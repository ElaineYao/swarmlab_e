...
%     vx_rel = vx_rel2 + vx_rel3 + vx_rel4;
    ...
    vy_rel = (3/(4*((delta_x - x1 + x2)^2 + (delta_y - y1 + y2)^2)^(1/2)) - 3/100)*(delta_y - y1 + y2) - (3/(4*((x1 - x4)^2 + (y1 - y4)^2)^(1/2)) - 3/100)*(y1 - y4) - (3/(4*((x1 - x3)^2 + (y1 - y3)^2)^(1/2)) - 3/100)*(y1 - y3);
    v_mat = [vx vy vx_rel vy_rel];

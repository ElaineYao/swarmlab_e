...
% Set the goal
% Front setting ----
p_swarm.x_goal = [350 350 350 350;150 150 150 150;-38 -38 -38 -38];
...
p_swarm.Pos0 = [px (px+dx) (px+dx_2) (px+dx_2); (150) 150 (150-dy_2) (150+dy_3); -38 -38 -38 -38];
